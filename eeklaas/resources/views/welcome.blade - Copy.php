        ...
        <div class="item">
            <div class="container">
                <div class="header-content">
                    <h1 class="header-title" style="color:#2a7a00">{{ $slider->title }}</h1>
                    <p class="header-sub-title" style="color:#2a7a00">{{ $slider->sub_title }}</p>
                </div> <!-- /.header-content -->
            </div>
        </div>
    @endforeach
        ...
        <section id="about" class="about">
            ...
            <div class="wrapper">
                <div class="container-fluid">
                        ...
                        <div class="col-xs-12 col-sm-6" style="margin-top:30px;margin-bottom:30px;">
                        <img src="{{ asset('uploads/about/'.$about->image)}}" class="img-responsive" alt="about" height="706" width="915">
                        </div>
                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach($items as $item)
                                  <li class="item" id="{{ $item->category->slug}}">
                                      ...
                                      <h2 class="white" style="color:#2a7a00">Tk {{$item->price}}</h2>
                                  </li>
                                @endforeach
        ...
        <section id="beer" class="beer">
            ...
            <div class="container-fluid">
              @foreach($enjoys as $enjoy)
                <div class="row dis-table">
                    <div class="col-sm-6">
                        <img style="margin-left: 125px" src="{{ asset('uploads/enjoy/'.$enjoy->image)}}" class="img-responsive" alt="enjoy">
                    </div>

                    <div class="col-xs-12 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <h2 class="section-content-title">{{$enjoy->title}}</h2>
        ...
        <section id="bread" class="bread">
            ...
            <div class="container-fluid">
              @foreach($bfasts as $bfast)
                <div class="row dis-table">
                    <div class="col-sm-6">
                        <img style="margin-left: 125px" src="{{ asset('uploads/bfast/'.$bfast->image)}}" class="img-responsive" alt="brekfast">
                    </div>

                    <div class="col-xs-12 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <h2 class="section-content-title">{{$bfast->title}}</h2>
                            <div class="section-description">
                                <p class="section-content-para">
                                    {{$bfast->description}}
                                </p>
                        ...
                        <div class="menu-gallery" style="width: 50%; float:left;">
                            <div class="flexslider-container">
                                <div class="flexslider">
                                    ...
                                    <li>
                                        <img src="{{ asset('uploads/fslider/'.$fslider->image) }}" />
                                    </li>
                                    @endforeach
                                    </ul>
                                </div>
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content" style="color:#267700">

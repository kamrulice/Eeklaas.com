<footer class="site-footer footer-opt-1">
    <div class="container">
      <div class="footer-column">
        <div class="row">
          <div class="col-md-3 col-lg-3 col-xs-6 col"> <strong class="logo-footer"> <a href="{{route('welcome')}}"><img src="{{ asset('frontend/images/icon/logo.png') }}" alt="logo"></a> </strong>
            <table class="address">
              <tr>
                <td><b>Address: </b></td>
          ...
          <div class="col-md-3 col-lg-3 col-xs-6 col">
            ...
            <div class="block-social">
              ...
              <div class="block-content"> <a href="https://www.facebook.com/" class="sh-facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a> <a href="https://www.pinterest.com/" class="sh-pinterest"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a> <a href="https://www.vk.com/" class="sh-vk"><i class="fa fa-vk" aria-hidden="true"></i></a> <a href="https://twitter.com/" class="sh-twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a> <a href="https://www.google.com/" class="sh-google"><i class="fa fa-google-plus" aria-hidden="true"></i></a> </div>
            </div>
          </div>
        </div>
      </div>
      <div class="payment-methods">
        ...
        <div class="block-content">
         <img alt="cash" src="{{ asset('frontend/images/media/index1/payment1.png') }}">
          <img alt="bkash" src="{{ asset('frontend/images/media/index1/payment2.png') }}">
           <img alt="payment" src="{{ asset('frontend/images/media/index1/payment3.png') }}"> 
           <img alt="payment" src="{{ asset('frontend/images/media/index1/payment5.png') }}"> 
           <img alt="payment" src="{{ asset('frontend/images/media/index1/payment4.png') }}"> 
           
           <img alt="payment" src="{{ asset('frontend/images/media/index1/payment6.png') }}"> 

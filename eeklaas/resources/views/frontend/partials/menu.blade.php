                    ...
                    <ul class="nav-right">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <img class="img rounded-circle" src="@if(Auth::check()){{App\Helpers\ImageHelper::getUserImage(Auth::User()->id)}}@endif" class="img rounded-circle" style="width: 40px;border-radius: 50%;">
            ...
            <div class="header-top">
                @if(Session::has('sellerId'))
                    ...
                    <li class="nav-item dropdown float-right">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            <img src="{{asset($seller->ProfileImage)}}" style="width: 40px;border-radius:50%;" class="img rounded-circle">
                            {{$seller->name}} <span class="caret"></span>
                        </a>
                            ...
                            <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                @csrf
                                        ...
                                        <div class="container">
                                            ...
                                            <ul class="nav-right">
                                                <li><a href="{{route('seller.register')}}" >Sell On Eelaas</a></li>
                                                <li class="dropdown setting"> <a data-toggle="dropdown" role="button" href="#" class="dropdown-toggle "><span>My Account</span> <i aria-hidden="true" class="fa fa-angle-down"></i></a>
                                                    <div class="dropdown-menu  ">
                                                        <ul class="account">
                                                            <li><a href="{{ route('wishlists')}}">Wishlist</a></li>
                        ...
                        <ul class="ui-categori">
                            @foreach(App\Category::all() as $category)
                                <li class="parent"> <a href="{{route('all-product',$category->id)}}"> <span class="icon">
                                    ...
                                    <div class="submenu row" style="background-image: url({{ asset('uploads/category/'.$category->image)}})">
                                        <ul class="categori-list clearfix col-md-12">

                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary" data-background-color="purple">
                            ...
                            <span class="float-right"><a href="{{route('all.banner')}}" class="btn btn-info">Manage Banner</a></span>
                        </div>
                        <div class="card-body">
                            <div class="col-md-8 offset-2">
                                <form method="POST" action="{{ route('seller.banner.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Title</label>
                                                <input type="text" class="form-control" name="title" value="{{$editBanner->title}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group label-floating">
                                                ...
                                                <textarea class="form-control" rows="5" name="description">{{$editBanner->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <img src="{{ asset('uploads/banner/'.$editBanner->image)}}"
